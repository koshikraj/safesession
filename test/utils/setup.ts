...
export const getSafeSessionModule = async () => {
  const ModuleDeployment = await deployments.get('SafeSessionModule')
  return await ethers.getContractAt('SafeSessionModule', ModuleDeployment.address)
}
